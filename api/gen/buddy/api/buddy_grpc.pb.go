...
func (c *buddyServiceClient) WatchBuddies(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (grpc.ServerStreamingClient[BuddyChanges], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BuddyService_ServiceDesc.Streams[0], BuddyService_WatchBuddies_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Nothing, BuddyChanges]{ClientStream: stream}
...
func (c *buddyServiceClient) IsBlocked(ctx context.Context, in *IsBlockedRequest, opts ...grpc.CallOption) (*IsBlockedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsBlockedResponse)
	err := c.cc.Invoke(ctx, BuddyService_IsBlocked_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBuddyServiceServer should be embedded to have
...
func (UnimplementedBuddyServiceServer) WatchBuddies(*Nothing, grpc.ServerStreamingServer[BuddyChanges]) error {
...
func (UnimplementedBuddyServiceServer) IsBlocked(context.Context, *IsBlockedRequest) (*IsBlockedResponse, error) {
...
func (UnimplementedBuddyServiceServer) testEmbeddedByValue() {}
...
func RegisterBuddyServiceServer(s grpc.ServiceRegistrar, srv BuddyServiceServer) {
	// If the following call pancis, it indicates UnimplementedBuddyServiceServer was
...
func _BuddyService_WatchBuddies_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BuddyServiceServer).WatchBuddies(m, &grpc.GenericServerStream[Nothing, BuddyChanges]{ServerStream: stream})
}
...
func _BuddyService_IsBlocked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsBlockedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BuddyServiceServer).IsBlocked(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BuddyService_IsBlocked_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BuddyServiceServer).IsBlocked(ctx, req.(*IsBlockedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
