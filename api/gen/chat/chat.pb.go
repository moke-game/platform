...
var file_chat_chat_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x07, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x22, 0x37, 0x0a, 0x0b, 0x44, 0x65,
	...
	0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71,
	...
	0x32, 0x20, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x44,
	...
	0x74, 0x2e, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x32, 0x17, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x45,
	...
	0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72,
	...
	0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68,
	...
	0x65, 0x64, 0x12, 0x1a, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x64, 0x64,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b,
	0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x64, 0x64, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x63,
...
var file_chat_chat_proto_goTypes = []any{
	(ChatError_Code)(0),             // 0: chat.pb.ChatError.Code
	...
	(*AddBlockedRequest)(nil),       // 6: chat.pb.AddBlockedRequest
	(*AddBlockedResponse)(nil),      // 7: chat.pb.AddBlockedResponse
	(*ChatMessage_Message)(nil),     // 8: chat.pb.ChatMessage.Message
	(*ChatRequest_Subscribe)(nil),   // 9: chat.pb.ChatRequest.Subscribe
	(*ChatRequest_UnSubscribe)(nil), // 10: chat.pb.ChatRequest.UnSubscribe
}
var file_chat_chat_proto_depIdxs = []int32{
	1,  // 0: chat.pb.ChatMessage.destination:type_name -> chat.pb.Destination
	8,  // 1: chat.pb.ChatMessage.message:type_name -> chat.pb.ChatMessage.Message
	9,  // 2: chat.pb.ChatRequest.subscribe:type_name -> chat.pb.ChatRequest.Subscribe
	10, // 3: chat.pb.ChatRequest.unsubscribe:type_name -> chat.pb.ChatRequest.UnSubscribe
	2,  // 4: chat.pb.ChatRequest.message:type_name -> chat.pb.ChatMessage
	0,  // 5: chat.pb.ChatError.code:type_name -> chat.pb.ChatError.Code
	2,  // 6: chat.pb.ChatResponse.message:type_name -> chat.pb.ChatMessage
	4,  // 7: chat.pb.ChatResponse.error:type_name -> chat.pb.ChatError
	1,  // 8: chat.pb.ChatRequest.Subscribe.destination:type_name -> chat.pb.Destination
	1,  // 9: chat.pb.ChatRequest.UnSubscribe.destination:type_name -> chat.pb.Destination
	3,  // 10: chat.pb.ChatService.Chat:input_type -> chat.pb.ChatRequest
	6,  // 11: chat.pb.ChatPrivateService.AddBlocked:input_type -> chat.pb.AddBlockedRequest
	5,  // 12: chat.pb.ChatService.Chat:output_type -> chat.pb.ChatResponse
	7,  // 13: chat.pb.ChatPrivateService.AddBlocked:output_type -> chat.pb.AddBlockedResponse
