...
require (
	...
	github.com/ThinkingDataAnalytics/go-sdk/v2 v2.3.0
	...
	github.com/gstones/moke-kit v1.0.5-0.20260918072054-388d523a53ef
	github.com/gstones/zinx v1.2.7-0.20240617071724-88bd884d8d08 // keep this commit; tagged @latest would downgrade to v1.2.6
...
require (
	...
	gorm.io/gorm v1.25.12 // indirect; stay on 1.25.x; 1.31.x Raw().Scan() zeros unselected fields (go-gorm/gorm#7746)
)
